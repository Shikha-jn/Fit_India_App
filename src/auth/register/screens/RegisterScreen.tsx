...
import ConditionChip from '../screens/ConditionChip';
import FitnessGoalSelect from '../screens/FitnessGoal';
import {
      RegisterFormState,
      RegisterPayload,
      RegisterableRole,
                  ...
                  >
                        ...
                        <View style={styles.header}>
                              ...
                              <Text style={styles.subtitle}>
                                    Empowering women across India with scientific fitness and nutrition programs.
                              </Text>
                        </View>
                        ...
                        <View style={styles.row}>
                              <LabeledInput
                                    ...
                                    containerStyle={styles.thirdItem}
                              />
                              <LabeledInput
                                    label="Height (cm)"
                                    placeholder="165"
                              ...
                              <LabeledInput
                                    ...
                                    onChangeText={(t) => update('currentWeight', t.replace(/[^0-9]/g, ''))}
